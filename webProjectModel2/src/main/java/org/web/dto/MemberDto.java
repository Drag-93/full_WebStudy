...
public class MemberDto {
	...
	public MemberDto(Long memberId, String userEmail, String userName, String userPw, int age, Role role,
	...
	public String toString() {
		return "MemberDto [memberId=" + memberId + ", userEmail=" + userEmail + ", userName=" + userName + ", userPw="
				+ userPw + ", age=" + age + ", role=" + role + ", createTime=" + createTime + ", updateTime="
				+ updateTime + "]";
	}
